<x-layout>
    ...
    <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        <h1 class="mb-4 text-3xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">New Category</h1>
        @if ($errors->any())
        ...
        @endif
        <form action="{{ url('/posts/bikin') }}" class="space-y-8" method="POST">
            @csrf
